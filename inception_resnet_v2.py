...
def inception_resnet_v2(inputs, dropout_keep_prob,
  ...
  # Aux branch
  aux = slim.fully_connected(aux, num_classes, activation_fn=None, scope='Aux_logits_new')
  end_points['AuxLogits'] = aux

  # Main branch
  logits = slim.fully_connected(net, num_classes, activation_fn=None, scope='Logits_new')
